...
pub(crate) fn register_lints(registry: &mut LintRegistryBuilder) {
    ...
    registry.register_lint(&MISSING_OVERRIDE);
...
declare_lint! {
    ...
    ///         return 2
    /// ```
    pub(crate) static MISSING_OVERRIDE = {
        summary: "detects methods that override a superclass member without `@override`",
        status: LintStatus::preview("0.0.34"),
        default_level: Level::Ignore,
    }
}
