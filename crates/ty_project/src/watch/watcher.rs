        ...
        let event = match kind {
            EventKind::Create(create) => {
                let kind = match create {
                    ...
                    CreateKind::Any | CreateKind::Other => {
                        CreatedKind::from(ExistingPathKind::from_path(&path))
                    }
                };
            ...
            EventKind::Modify(modify) => match modify {
                ModifyKind::Metadata(metadata) => {
                    if ExistingPathKind::from_path(&path) != ExistingPathKind::File {
                ...
                ModifyKind::Name(rename) => match rename {
                    ...
                    RenameMode::To => ChangeEvent::Created {
                        kind: CreatedKind::from(ExistingPathKind::from_path(&path)),
                        path,
                    },
                    ...
                    RenameMode::Any => {
                        ...
                        if path.as_std_path().exists() {
                            let file_type = ExistingPathKind::from_path(&path);
                ...
                ModifyKind::Any => {
                    if !ExistingPathKind::from_path(&path).is_file() {
                        return;
                    }
